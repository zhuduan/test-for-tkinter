...
class Application(ttk.Frame):
    ...
    def init_gui(self):
        ...
        self.calc_button =ttk.Button(self, text='计算',command=self.add_two_num)
        self.calc_button.grid(column=0, row=3, columnspan=4)
        createToolTip(self.calc_button, "it is a button")
        ...
        createToolTip(self.answer_label, "it is a label")
